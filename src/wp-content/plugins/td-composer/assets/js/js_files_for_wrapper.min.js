...
tdcOperationUI.getDraggedElement(),e=tdcOperationUI.getCurrentElementOver(),c=tdcAdminWrapperUI.$placeholder,g="";if(!(b.isUndefined(a)||b.isUndefined(e)||b.isUndefined(c)||!c.is(":visible")&&e!==tdcAdminWrapperUI.$recycle)){var l=tdcOperationUI.isSidebarElementDragged(),n=tdcOperationUI.isElementDragged(),k=!1,m=!1,p=!1,q=!1,r=!1,u=!1,x=tdcOperationUI.isElementWithRowDragged(),t=tdcOperationUI.getRowStartValues();if(n){var w=a.closest(".tdc-elements");if(!l&&(g=tdcIFrameData._getSourceCol(tdcOperationUI.getDraggedElement()),
b.isUndefined(g)))return}else(k=tdcOperationUI.isInnerColumnDragged())&&(w=a.closest(".tdc-inner-columns"));!k&&(m=tdcOperationUI.isInnerRowDragged(),p=tdcOperationUI.isTempInnerRowDragged(),m||p)&&(w=a.closest(".tdc-elements"));m||p||(q=tdcOperationUI.isColumnDragged())&&(w=a.closest(".tdc-columns"));!q&&(r=tdcOperationUI.isRowDragged(),u=tdcOperationUI.isTempRowDragged(),r||u)&&(w=a.closest(".tdc-rows"));if(l||n||k||m||p||q||r||u){var B="",z=a.find(".td_block_inner");z.length&&(B=z.attr("id"));
if(!l&&!b.isUndefined(w)&&w.length){var v=w.children();z=v.index(a);var y=v.index(c);if(e!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(z-y))return;if(n||m||p||r||u){if((n||m||r)&&e===tdcAdminWrapperUI.$recycle){c="Deleting ";tdConfirm.showModal(m?c+"inner row":r?c+"row":c+"element",tdcOperationUI,function(){if((-1===y&&1===v.length||2===v.length&&-1!==y)&&(!r||1!==tdcIFrameData.tdcRows.length)){var b="";A=a.closest(".tdc-inner-column");A.length?b=" tdc-element-inner-column":(C=a.closest(".tdc-column"),
...
q.cid),b.isUndefined(g)||(n.add(q,{at:h}),g.set("childCollection",n),q.set("childCollection",new tdcIFrameData.TdcCollection)),q.getShortcodeRender(1,a.draggedBlockUid,!0)):(m=JSON.parse(window.atob(m)).reverse(),b.map(m,function(d,e){setTimeout(function(){console.log(e);0!==e&&(c=f(c[0].outerHTML).insertBefore(c),c.html(""),c.addClass("tdc-dropped"));var l=new tdcIFrameData.TdcModel({templateContent:window.btoa(d),attrs:{},tag:"vc_row",type:"template",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:l,
el:c[0]});h=c.prevAll(".tdc-row").length;c.data("model_id",l.cid);b.isUndefined(g)||(n.add(l,{at:h}),g.set("childCollection",n),l.set("childCollection",new tdcIFrameData.TdcCollection));l.getShortcodeRender(1,a.draggedBlockUid,!0)},500+2E3*parseInt(e,10))}));else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),m=c.data("templateContent"),!b.isUndefined(m)){k=c.data("model_id");if(b.isUndefined(k)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,
...
"");"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l&&(l="");if("11"===c)if("23"===d)if("23_13"===l){var k=e.at(0),n=e.at(1);g=k.get("attrs");h=n.get("attrs");g=b.clone(g);h=b.clone(h);g.width="1/2";h.width="1/2";k.set("attrs",g);n.set("attrs",h)}else if("13_23"===l)k=e.at(0),n=e.at(1),g=k.get("attrs"),h=n.get("attrs"),g=b.clone(g),h=b.clone(h),g.width="1/2",h.width="1/2",k.set("attrs",g),n.set("attrs",h);else if("13_13_13"===l){k=e.at(0);n=e.at(1);e=e.at(2);g=k.get("attrs");h=n.get("attrs");
var f=e.get("attrs");g=b.clone(g);h=b.clone(h);b.clone(f);g.width="1/2";h.width="1/2";k.set("attrs",g);n.set("attrs",h);h=e.get("childCollection");if(!b.isUndefined(h)&&h.length){var m=n.get("childCollection");b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,n.set("childCollection",m));b.each(h.models,function(a,b,c){m.add(a);a.set("parentModel",n)})}tdcIFrameData.removeModel(e)}else{if(e.models.length){k=e.at(0);g=k.get("attrs");g=b.clone(g);var t=k.get("childCollection");delete g.width;k.set("attrs",
...
t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else if("23"===c)if("11"===d)if("12_12"===l)k=e.at(0),n=e.at(1),g=k.get("attrs"),h=n.get("attrs"),g=b.clone(g),h=b.clone(h),g.width="1/3",h.width="1/3",k.set("attrs",g),n.set("attrs",h),h=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,
...
b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else if("13"===c)if("11"===d)if(""===l||"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l){if(e.models.length)for(k=e.at(0),g=k.get("attrs"),
g=b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else"12_12"===l&&e.models.length&&(k=e.at(0),n=e.at(1),g=k.get("attrs"),h=n.get("attrs"),g.width="1/3",h.width="1/3",k.set("attrs",g),n.set("attrs",
h),e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===d&&(""===l||"12_12"!==l)&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",
...
q.get("attrs"),h=q.get("childCollection"),k=e.at(1),n=k.get("childCollection"),a=e.at(2),e=a.get("childCollection"),b.isUndefined(r)||(r=b.clone(r),delete r.width,q.set("attrs",r)),b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h)),!b.isUndefined(n)&&n.length&&b.each(n.models,function(a,b,c){a.set("parentModel",q);h.add(a)}),!b.isUndefined(e)&&e.length&&b.each(e.models,function(a,b,c){a.set("parentModel",q);h.add(a)}),tdcIFrameData.removeModel(k)):(f=d.split("_"),p=f[0].charAt(0)+
"/"+f[0].charAt(1),c=f[1].charAt(0)+"/"+f[1].charAt(1),q=e.at(0),r=q.get("attrs"),k=e.at(1),d=k.get("attrs"),n=k.get("childCollection"),a=e.at(2),e=a.get("childCollection"),r=b.clone(r),r.width=p,q.set("attrs",r),d=b.clone(d),d.width=c,k.set("attrs",d),b.isUndefined(n)&&(n=new tdcIFrameData.TdcCollection,k.set("childCollection",n)),!b.isUndefined(e)&&e.length&&b.each(e.models,function(a,b,c){a.set("parentModel",k);n.add(a)})),tdcIFrameData.removeModel(a));else if("11"===d){q=e.at(0);r=q.get("attrs");
var h=q.get("childCollection");k=e.at(1);var n=k.get("childCollection");b.isUndefined(r)||(r=b.clone(r),delete r.width,q.set("attrs",r));b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h));!b.isUndefined(n)&&n.length&&b.each(n.models,function(a,b,c){a.set("parentModel",q);h.add(a)});tdcIFrameData.removeModel(k)}else f=d.split("_"),p=f[0].charAt(0)+"/"+f[0].charAt(1),c=f[1].charAt(0)+"/"+f[1].charAt(1),q=e.at(0),r=q.get("attrs"),k=e.at(1),d=k.get("attrs"),r=b.clone(r),
r.width=p,q.set("attrs",r),d=b.clone(d),d.width=c,k.set("attrs",d),3===f.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:f[2].charAt(0)+"/"+f[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var k=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),f=d.split("_"),p=f[0].charAt(0)+"/"+f[0].charAt(1);c=f[1].charAt(0)+"/"+f[1].charAt(1);var q=e.at(0),r=q.get("attrs");b.isUndefined(r)?q.set("attrs",{width:p}):
(r=b.clone(r),r.width=p,q.set("attrs",r));k.set("attrs",{width:c});e.add(k);3===f.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:f[2].charAt(0)+"/"+f[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;b.map(a.models,function(a,d){a=a.get("attrs");b.has(a,"width")&&(c=b.isUndefined(c)?a.width.replace("/",""):c+("_"+a.width.replace("/","")))});return c}}}})(jQuery,Backbone,_);var tdcAdminIFrameUI;
...
function(b){var c=jQuery(this),a=c.closest(".tdc-property-responsive"),e=a.find('input[type="range"]'),h=a.find('input[type="radio"]:checked'),g=a.find('input[type="text"]'),l=e.get(0),f="",k=h.data("default_value"),m=tdcIFrameData.getModel(e.data("model_id")),p=e.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],r=m="";var u=[];for(var x=0;x<q.params.length;x++)if(p===q.params[x].param_name){x=q.params[x].tdc_values;for(var t in x)x.hasOwnProperty(t)&&(u.push(x[t].unit),
""===m||""===r)&&(m=x[t].value,r=x[t].unit);break}h.length&&(f=h.data("unit_value"));if("range"===c.attr("type"))u=e.val(),g.val(u),h.data("last_value",u),g.val(u),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),u+f,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===c.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");u=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
u||_.isUndefined(k)||""===k?(e.val(u),h.data("last_value",u),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),u+f,tdcSidebar.currentViewportSettings.name))):(e.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),e.data("range_value",m),e.data("range_unit",r),e.val(m),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),t=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+q),f.prop("checked",
!0),l.min=t,l.max=h,l.step=q,l.value=m,f.data("last_value",m),g.val(m));else if(""===u)if(f=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all"),"undefined"===typeof f)e.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),e.data("range_value",m),e.data("range_unit",r),e.val(m),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),t=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+q),f.prop("checked",
!0),l.min=t,l.max=h,l.step=q,l.value=m,f.data("last_value",m),g.val(m),a.addClass("tdc-css-inherited");else for(x=0;x<q.params.length;x++){if(p===q.params[x].param_name){u=[];g=[];x=q.params[x].tdc_values;for(t in x)x.hasOwnProperty(t)&&u.push(x[t].unit);for(x=0;x<u.length&&!(g=f.split(u[x]),1<g.length);x++);g.length&&(m=g[0],r=u[x],e.data("range_value",m),e.data("range_unit",r),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),t=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+
q),f.prop("checked",!0),l.min=t,l.max=h,l.step=q,l.value=m,f.data("last_value",m),a.find('input[type="text"]').val(m));e.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name));a.addClass("tdc-css-inherited");break}}else e.val(u),h.data("last_value",u),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),u+f,tdcSidebar.currentViewportSettings.name))}else if("radio"===c.attr("type")){if("input"===b.type)return;
p=h.data("last_value");q=h.data("unit");t=e.data("min_"+q);h=e.data("max_"+q);q=e.data("step_"+q);l.min=t;l.max=h;l.step=q;""===p?(g.val(k),e.val(k),u=k):(g.val(p),e.val(p),u=p);e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),u+f,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}f="";a=jQuery(l).parent().find('input[type="radio"]:checked');a.length&&(f=jQuery(a[0]).data("unit_value"));"focusin"===b.type?l.oldValue=l.value+f:(a=jQuery(l),
...
!0)}e||delete a[k]}break;case 3:h=e[0];l=e[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){q=p;break}e=!1;for(m in b)if(h===b[m]&&m===q+"-"+l){e=!0;break}e||_.has(b,q+"-"+l)&&""===b[q+"-"+l]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=!0);e||delete a[k]}var r=[],u;for(u in window.tdcAdminSettings.listStyles[d])if(u===c){for(g=0;g<window.tdcAdminSettings.listStyles[d][u].length;g++)k=window.tdcAdminSettings.listStyles[d][u][g],_.isArray(k)?
...
_.isEmpty(b.params[a].group)||(e=b.params[a].group);d.push(e)}d=_.uniq(d);var h=e="",g=tdcSidebar.getCurrentTabId(),l,f;e+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var k=f=l="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);var m=tdcUtil.makeSafeForCSS(h);0===a?(l='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>',f='<a href="#" data-tab-id="td-tab-'+m+'" title="'+h+' settings">'+
h+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+m?k+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>':(l=f,k+='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>')}e=e+(l+k)+"</div>";k=f=l=a="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "phone":k=
"selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":l="selected";break;case "portrait":f="selected";break;case "phone":k="selected"}e+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';tdcState.isMobileComposer()?e=e+('<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+a+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div><div class="tdc-responsive-phone ')+(k+'" title="Portrait viewport"><span class="tdc-phone-icon"></span></div>'):
(e+='<div class="tdc-responsive-all '+a+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>',"Newspaper"===window.tdcAdminSettings.themeName&&(e+='<div class="tdc-responsive-tablet-landscape '+l+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>'),e+='<div class="tdc-responsive-tablet-portrait '+f+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>',e+='<div class="tdc-responsive-phone '+k+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>');
e+="</div>";e+="</div>";e+='<div class="tdc-search">';e+='<i class="td-icon-search"></i>';e+='<input type="text" placeholder="Search settings..." />';e+="</div></div>";e+='<div class="tdc-sidebar-sticky-a"></div>';e+='<div class="tdc-sidebar-sticky-b"></div>';e+='<div class="tdc-tab-content-wrap" data-tag="'+c.get("tag")+'">';k=f=l="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);m=tdcUtil.makeSafeForCSS(h);h="tdc-tab-no-design";var p=c.get("tag");"css"===m&&(h="tdc-tab-design");0===
a?(l='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+m+'">',f='<div class="tdc-tab-content '+h+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,c.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&c.set("presetValues",m)),c.has("presetValues")&&(m=c.get("presetValues"),k+=tdcSidebarPanel._addPresetValuesSelector(m,c))):_.isUndefined(g)||g!=="td-tab-"+m?k+='<div class="tdc-tab-content '+h+'" id="td-tab-'+
m+'">':(l=f,k+='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+m+'">');k+=tdcSidebarPanel._bindGroupAndGetHtml(d[a],b,c);m=' data-model_id="'+c.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(k+='<div class="tdc-sidebar-row-buttons">',k+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+m+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',k+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+m+' title="Get the current styles\' settings">CONSOLE: style presets</div>',
...
!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var p="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(p='data-disabled-by="'+c.toggle_disabled_by+'"');var q=e="",r=!1,u=Object.keys(c.value),x=!0;if(_.has(c,"tdc_min_options")&&u.length<=parseInt(c.tdc_min_options))return e;for(var t=0;t<u.length;t++){var w=!1,B="",z="",v="",y="",A="",C=u[t],E=String(tdcSidebarPanel._getParameterCurrentValue(c,
...
var g="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var l="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');var k="",m="",p=Object.keys(c.value);if(_.has(c,"tdc_min_options")&&p.length<=parseInt(c.tdc_min_options))return k;var q=' data-responsive="" ',
...
"vc_row_inner"!==b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(v="col_"+v);m+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+w+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+t+' value="'+z+'" '+q+">";e?(t="",x&&(t="tdc-standard-value"),m+='<label class="tdc-property-input-radio-label '+t+'" for="'+w+'" title="'+B+'"><div class="'+v+'"></div></label>'):m+='<label class="tdc-property-input-radio-label" for="'+w+'" title="'+
B+'">'+z+"</label>"}else r===z&&(t=' selected="selected" '),"__"===z.substring(0,2)&&-1!==B.search("--")&&(w=" disabled "),m+="<option "+t+" "+w+' value="'+z+'">'+B+"</option>"}p="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':p=' title="'+c.description+'" ');k+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+l+" "+f+">";k+='<div class="tdc-property-title"><span class="tdc-search-data"'+p+">"+c.heading+
'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';k+='<div class="tdc-property">';e||h?k+=m:(k+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+q+p+">",k=k+m+"</select>");k=k+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return k+"</div>"},addCheckBox:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+
...
'" type="range" data-value="'+u+'" data-min="'+g+'" data-max="'+h+'" data-step="'+l+'" min="'+g+'" max="'+h+'" step="'+l+'" value="'+u+'" '+r+" />");d=d+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" '+k+' value="'+u+'"/></div><span class="tdc-param-name">')+(c.param_name+"</span>");return d+="</div>"},addRangeMultiple:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&
...
b),m="",p="",q=[],r="",u="",x="",t="",w="",B="",z="",v;for(v in f)f.hasOwnProperty(v)&&(q.push(f[v].unit),""===u||""===r)&&(t=f[v].unit,u=' data-range_unit="'+t+'" ',x=f[v].value,r=' data-range_value="'+x+'" ',w=f[v].range_min,B=f[v].range_max,z=f[v].range_step);if(""!==k){for(var y=[],A=0;A<q.length&&!(y=k.split(q[A]),1<y.length);A++);y.length&&(t=q[A],u=' data-range_unit="'+t+'" ',x=y[0],r=' data-range_value="'+x+'" ')}for(v in f)f.hasOwnProperty(v)&&(k=_.uniqueId(),m+=" data-value_"+v+'="'+f[v].value+
'" ',m+=" data-min_"+v+'="'+f[v].range_min+'" ',m+=" data-max_"+v+'="'+f[v].range_max+'" ',m+=" data-step_"+v+'="'+f[v].range_step+'" ',q=f[v].value,y="",f[v].unit===t&&(q=x,w=f[v].range_min,B=f[v].range_max,z=f[v].range_step,y="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+v+'" data-unit_value="'+f[v].unit+'" type="radio" id="'+k+'" '+y+' data-default_value="'+f[v].value+'" data-last_value="'+q+'"/>',p+='<label for="'+k+'">'+f[v].unit+"</label>");d='<div class="'+
tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+r+" "+u+" "+m+' min="'+w+'" max="'+B+'" step="'+z+'" value="'+x+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
...
(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,b),m="",p="",q=[],r=' data-responsive="" ',u="",x="",t="",w="",B="",z="",v="",y;for(y in f)f.hasOwnProperty(y)&&(q.push(f[y].unit),""===x||""===u)&&
...
(q=_.uniqueId(),m+=" data-value_"+y+'="'+f[y].value+'" ',m+=" data-min_"+y+'="'+f[y].range_min+'" ',m+=" data-max_"+y+'="'+f[y].range_max+'" ',m+=" data-step_"+y+'="'+f[y].range_step+'" ',A=f[y].value,k="",f[y].unit===w&&(A=t,B=f[y].range_min,z=f[y].range_max,v=f[y].range_step,k="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+y+'" data-unit_value="'+f[y].unit+'" type="radio" id="'+q+'" '+k+' data-default_value="'+f[y].value+'" data-last_value="'+A+'"/>',
p+='<label for="'+q+'">'+f[y].unit+"</label>");d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+u+" "+x+" "+m+" "+r+' min="'+B+'" max="'+z+'" step="'+v+'" value="'+
...
l=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),k=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),r=b.find(".tdc-css-box-input-padding-right").val().trim(),u=b.find(".tdc-css-box-input-padding-bottom").val().trim(),x=b.find(".tdc-css-box-input-padding-left").val().trim(),
...
d);""!==f&&(a["margin-right"]=f);""!==g&&(a["margin-bottom"]=g);""!==l&&(a["margin-left"]=l);""!==n&&(a["border-top-width"]=n);""!==k&&(a["border-right-width"]=k);""!==m&&(a["border-bottom-width"]=m);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==r&&(a["padding-right"]=r);""!==u&&(a["padding-bottom"]=u);""!==x&&(a["padding-left"]=x);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=
...
f('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(l);var u=f('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(l);q=f('<div class="tdc-gradient-values-wrapper"></div>').appendTo(l);var x=f('<div class="tdc-gradient-values"></div>').appendTo(q);q=f('<div class="tdc-gradient-color-values-wrapper"></div>').appendTo(l);q=f('<div class="tdc-gradient-color-values"></div>').appendTo(q);if("undefined"!==typeof c.tdcAdminSettings.tdcSavings.gradients&&c.tdcAdminSettings.tdcSavings.gradients.length)for(var t=
!1,w=c.tdcAdminSettings.tdcSavings.gradients.length-1;0<=w;w--){var B=c.tdcAdminSettings.tdcSavings.gradients[w];try{var z=JSON.parse(c.atob(B));"undefined"!==typeof z.css&&(t=!0,f('<div class="tdc-gradient-value" style="'+z.css+'" data-gradient="'+B+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(x))}catch(y){}}t||u.hide();a.$container=l;a.$gradientResult=r;if("undefined"!==typeof c.tdc_wm_global_colors){var v=f('<div class="tdc-global-colors-values"></div>').insertAfter(l.find(".tdc-gradient-values-wrapper"));
