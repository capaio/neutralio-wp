	...
	public function get_custom_css() {
		...
		$raw_css =
            "<style>
                ...
                .tds_my_account .tds-s-subscr-remaining-credits {
                    display: flex;
                    flex-wrap: wrap;
                    gap: .857em;
                }
                .tds_my_account .tds-s-subscr-remaining-posts .tds-s-btn,
                .tds_my_account .tds-s-subscr-remaining-credits .tds-s-btn {
                    padding: 10px 19px 11px;
                    cursor: default;
                }
                .tds_my_account .tds-s-subscr-remaining-posts .tds-s-btn:hover,
                .tds_my_account .tds-s-subscr-remaining-credits .tds-s-btn:hover,
                .tds_my_account .tds-s-subscr-remaining-posts .tds-s-btn:active,
                .tds_my_account .tds-s-subscr-remaining-credits .tds-s-btn:active {
                ...
                .tds_my_account .tds-s-subscr-remaining-credits .tds-s-btn .tds-s-subscr-rp-type {
                    line-height: 0;
                }
                .tds_my_account .tds-s-subscr-remaining-posts .tds-s-btn .tds-s-subscr-rp-count,
                .tds_my_account .tds-s-subscr-remaining-credits .tds-s-btn .tds-s-subscr-rp-count {
                    display: flex;
                    align-items: center;
                    justify-content: center;
                    min-width: 17px;
                ...
                body .$unique_block_class .tds-s-subscr-remaining-credits .tds-s-subscr-rp-item,
                body .$unique_block_class .tds-s-subscr-remaining-posts .tds-s-subscr-rp-item:hover,
                body .$unique_block_class .tds-s-subscr-remaining-credits .tds-s-subscr-rp-item:hover {
                ...
                body .$unique_block_class .tds-s-subscr-remaining-credits .tds-s-subscr-rp-item .tds-s-subscr-rp-count {
