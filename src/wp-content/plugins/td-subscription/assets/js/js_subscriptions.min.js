...
b=jQuery(".td-op-meta-box-row-cf .td-meta-box-col-title, .td-meta-box-col-title-cf"),d=jQuery(".tds-paid-subscription-settings");"#tds-input-placeholder #tds-locker-cf-1-state #tds-locker-cf-1-req #tds-locker-cf-1-name #tds-locker-cf-2-state #tds-locker-cf-2-req #tds-locker-cf-2-name #tds-locker-cf-3-state #tds-locker-cf-3-req #tds-locker-cf-3-name #tds-input-color #tds-input-color-h #tds-input-bg-color #tds-input-bg-color-h #tds-input-border-color #tds-input-border-color-h #tds-tds_input-font_size #tds-access-settings".split(" ").forEach(function(c){c=
jQuery(c);if(c.length&&(c=c.closest(".td-meta-box-row"),c.length))switch(a.val()){case "paid_subscription":d.removeClass("td-op-disabled");c.addClass("td-op-disabled");b.addClass("td-op-disabled");break;default:d.addClass("td-op-disabled"),c.removeClass("td-op-disabled"),b.removeClass("td-op-disabled")}})}).on("change","#tds-locker-credits-unlock",function(){var a=jQuery(this),b=jQuery(".td-meta-box-col-title-cl");"#tds-locker-credits-title #tds-locker-credits-message #tds-locker-credits-btn-text #tds-locker-credits-redr-url #tds-locker-credits-enable #tds-locker-credits-sep-text #tds-tds_lc_sep-font_size".split(" ").forEach(function(d){d=
jQuery(d);d.length&&(d=d.closest(".td-meta-box-row"),d.length&&(a.is(":checked")?(d.removeClass("td-op-disabled"),b.removeClass("td-op-disabled")):(d.addClass("td-op-disabled"),b.addClass("td-op-disabled"))))})});jQuery("#tds-locker-type").trigger("change")},get_rest_endpoint:function(c,a){return h.isEmpty(window.tds_js_globals.permalinkStructure)?window.tds_js_globals.wpRestUrl+c+"&"+a:window.tds_js_globals.wpRestUrl+c+"?"+a},get_unique_id:function(){function c(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}
return c()+c()+"-"+c()+"-"+c()+"-"+c()+"-"+c()+c()+c()}};tdSubscriptions.init()})(jQuery,_);
